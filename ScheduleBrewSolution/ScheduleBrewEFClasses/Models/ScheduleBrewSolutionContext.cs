...
{
    public partial class ScheduleBrewSolutionContext : DbContext
    {
        public ScheduleBrewSolutionContext()
        {
        }

        public ScheduleBrewSolutionContext(DbContextOptions<ScheduleBrewSolutionContext> options)
            : base(options)
        {
        }
